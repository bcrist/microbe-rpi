...
pub const RTC: *volatile types.clk.RTC = @ptrFromInt(0x4005C000);
pub const TIMER: *volatile types.clk.TIMER = @ptrFromInt(0x40054000);
...
pub const DMA: *volatile types.dma.DMA = @ptrFromInt(0x50000000);
...
pub const USB: *volatile types.usb.REGS = @ptrFromInt(0x50110000);
pub const USB_BUF: *volatile types.usb.BUF = @ptrFromInt(0x50100000);
