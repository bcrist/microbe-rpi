...
pub const PIO = extern struct {
    ...
    SM0_CLKDIV: Mmio(packed struct(u32) {
        _reserved_0: u8 = 0,
        FRAC: u8 = 0,
        INT: u16 = 1,
    }, .rw),
    SM0_EXECCTRL: Mmio(packed struct(u32) {
        STATUS_N: u4 = 0,
        STATUS_SEL: enum(u1) {
            TXLEVEL = 0x0,
            RXLEVEL = 0x1,
    ...
    SM0_SHIFTCTRL: Mmio(packed struct(u32) {
        _reserved_0: u16 = 0,
        AUTOPUSH: u1 = 0,
        AUTOPULL: u1 = 0,
        IN_SHIFTDIR: u1 = 1,
    ...
    SM0_PINCTRL: Mmio(packed struct(u32) {
        OUT_BASE: u5 = 0,
        SET_BASE: u5 = 0,
        SIDESET_BASE: u5 = 0,
        IN_BASE: u5 = 0,
    ...
    SM1_CLKDIV: Mmio(packed struct(u32) {
        _reserved_0: u8 = 0,
        FRAC: u8 = 0,
        INT: u16 = 1,
    }, .rw),
    SM1_EXECCTRL: Mmio(packed struct(u32) {
        STATUS_N: u4 = 0,
        STATUS_SEL: enum(u1) {
            TXLEVEL = 0x0,
            RXLEVEL = 0x1,
    ...
    SM1_SHIFTCTRL: Mmio(packed struct(u32) {
        _reserved_0: u16 = 0,
        AUTOPUSH: u1 = 0,
        AUTOPULL: u1 = 0,
        IN_SHIFTDIR: u1 = 1,
    ...
    SM1_PINCTRL: Mmio(packed struct(u32) {
        OUT_BASE: u5 = 0,
        SET_BASE: u5 = 0,
        SIDESET_BASE: u5 = 0,
        IN_BASE: u5 = 0,
    ...
    SM2_CLKDIV: Mmio(packed struct(u32) {
        _reserved_0: u8 = 0,
        FRAC: u8 = 0,
        INT: u16 = 1,
    }, .rw),
    SM2_EXECCTRL: Mmio(packed struct(u32) {
        STATUS_N: u4 = 0,
        STATUS_SEL: enum(u1) {
            TXLEVEL = 0x0,
            RXLEVEL = 0x1,
    ...
    SM2_SHIFTCTRL: Mmio(packed struct(u32) {
        _reserved_0: u16 = 0,
        AUTOPUSH: u1 = 0,
        AUTOPULL: u1 = 0,
        IN_SHIFTDIR: u1 = 1,
    ...
    SM2_PINCTRL: Mmio(packed struct(u32) {
        OUT_BASE: u5 = 0,
        SET_BASE: u5 = 0,
        SIDESET_BASE: u5 = 0,
        IN_BASE: u5 = 0,
    ...
    SM3_CLKDIV: Mmio(packed struct(u32) {
        _reserved_0: u8 = 0,
        FRAC: u8 = 0,
        INT: u16 = 1,
    }, .rw),
    SM3_EXECCTRL: Mmio(packed struct(u32) {
        STATUS_N: u4 = 0,
        STATUS_SEL: enum(u1) {
            TXLEVEL = 0x0,
            RXLEVEL = 0x1,
    ...
    SM3_SHIFTCTRL: Mmio(packed struct(u32) {
        _reserved_0: u16 = 0,
        AUTOPUSH: u1 = 0,
        AUTOPULL: u1 = 0,
        IN_SHIFTDIR: u1 = 1,
    ...
    SM3_PINCTRL: Mmio(packed struct(u32) {
        OUT_BASE: u5 = 0,
        SET_BASE: u5 = 0,
        SIDESET_BASE: u5 = 0,
        IN_BASE: u5 = 0,
    ...
    IRQ0_INTE: Mmio(packed struct(u32) {
        SM0_RXNEMPTY: u1 = 0,
        SM1_RXNEMPTY: u1 = 0,
        SM2_RXNEMPTY: u1 = 0,
        SM3_RXNEMPTY: u1 = 0,
    ...
    IRQ0_INTF: Mmio(packed struct(u32) {
        SM0_RXNEMPTY: u1 = 0,
        SM1_RXNEMPTY: u1 = 0,
        SM2_RXNEMPTY: u1 = 0,
        SM3_RXNEMPTY: u1 = 0,
    ...
    IRQ0_INTS: Mmio(packed struct(u32) {
        SM0_RXNEMPTY: u1 = 0,
        SM1_RXNEMPTY: u1 = 0,
        SM2_RXNEMPTY: u1 = 0,
        SM3_RXNEMPTY: u1 = 0,
    ...
    IRQ1_INTE: Mmio(packed struct(u32) {
        SM0_RXNEMPTY: u1 = 0,
        SM1_RXNEMPTY: u1 = 0,
        SM2_RXNEMPTY: u1 = 0,
        SM3_RXNEMPTY: u1 = 0,
    ...
    IRQ1_INTF: Mmio(packed struct(u32) {
        SM0_RXNEMPTY: u1 = 0,
        SM1_RXNEMPTY: u1 = 0,
        SM2_RXNEMPTY: u1 = 0,
        SM3_RXNEMPTY: u1 = 0,
    ...
    IRQ1_INTS: Mmio(packed struct(u32) {
        SM0_RXNEMPTY: u1 = 0,
        SM1_RXNEMPTY: u1 = 0,
        SM2_RXNEMPTY: u1 = 0,
        SM3_RXNEMPTY: u1 = 0,
