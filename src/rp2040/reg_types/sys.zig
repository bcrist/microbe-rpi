...
pub const SIO = extern struct {
    ...
    INTERP0_CTRL_LANE1: Mmio(packed struct(u32) {
        SHIFT: u5 = 0,
        MASK_LSB: u5 = 0,
        MASK_MSB: u5 = 0,
        SIGNED: u1 = 0,
    ...
    INTERP1_CTRL_LANE1: Mmio(packed struct(u32) {
        SHIFT: u5 = 0,
        MASK_LSB: u5 = 0,
        MASK_MSB: u5 = 0,
        SIGNED: u1 = 0,
...
pub const RESETS = extern struct {
    ...
    RESET_DONE: Mmio(packed struct(u32) {
        adc: u1 = 0,
        busctrl: u1 = 0,
        dma: u1 = 0,
        i2c0: u1 = 0,
...
pub const PSM = extern struct {
    FRCE_ON: Mmio(packed struct(u32) {
        rosc: u1 = 0,
        xosc: u1 = 0,
        clocks: u1 = 0,
        resets: u1 = 0,
    ...
    FRCE_OFF: Mmio(packed struct(u32) {
        rosc: u1 = 0,
        xosc: u1 = 0,
        clocks: u1 = 0,
        resets: u1 = 0,
