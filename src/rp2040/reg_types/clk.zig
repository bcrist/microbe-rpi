...
pub const RoscStageDriveStrength = enum(u3) {
    @"1x" = 0,
    @"2x" = 1,
    @"3x" = 3,
    @"4x" = 7,
...
pub const ROSC = extern struct {
    ...
    drive0: Mmio(packed struct(u32) {
        stage0: RoscStageDriveStrength = .@"1x",
        _reserved_3: u1 = 0,
        stage1: RoscStageDriveStrength = .@"1x",
        _reserved_7: u1 = 0,
        stage2: RoscStageDriveStrength = .@"1x",
        _reserved_b: u1 = 0,
        stage3: RoscStageDriveStrength = .@"1x",
        _reserved_f: u1 = 0,
        write_enable_key: u16 = 0x9696,
    }, .rw),
    drive1: Mmio(packed struct(u32) {
        stage4: RoscStageDriveStrength = .@"1x",
        _reserved_3: u1 = 0,
        stage5: RoscStageDriveStrength = .@"1x",
        _reserved_7: u1 = 0,
        stage6: RoscStageDriveStrength = .@"1x",
        _reserved_b: u1 = 0,
        stage7: RoscStageDriveStrength = .@"1x",
        _reserved_f: u1 = 0,
        write_enable_key: u16 = 0x9696,
    }, .rw),
    pause: Mmio(enum(u32) {
...
pub const RefClockGenerator = extern struct {
    control: Mmio(packed struct(u32) {
        source: enum(u2) {
            rosc = 0,
            aux = 1,
...
pub const SysClockGenerator = extern struct {
    control: Mmio(packed struct(u32) {
        source: enum(u1) {
            clk_ref = 0,
            aux = 1,
...
pub const PeriClockGenerator = extern struct {
    control: Mmio(packed struct(u32) {
        _reserved_0: u5 = 0,
        source: enum(u3) {
            clk_sys = 0,
...
pub const UsbAdcClockGenerator = extern struct {
    control: Mmio(packed struct(u32) {
        _reserved_0: u5 = 0,
        source: enum(u3) {
            pll_usb = 0,
...
pub const RtcClockGenerator = extern struct {
    control: Mmio(packed struct(u32) {
        _reserved_0: u5 = 0,
        source: enum(u3) {
            pll_usb = 0,
...
pub const CLOCKS = extern struct {
    gpout: [4]GpoutClockGenerator,
    ref: RefClockGenerator,
    sys: SysClockGenerator,
    peri: PeriClockGenerator,
    usb: UsbAdcClockGenerator,
    adc: UsbAdcClockGenerator,
    rtc: RtcClockGenerator,
    resus: extern struct {
        control: Mmio(packed struct(u32) {
            timeout: u8 = 0xFF,
            enabled: bool = false,
