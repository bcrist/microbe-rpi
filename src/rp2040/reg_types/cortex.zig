...
pub const NVIC = extern struct {
    /// a.k.a. ISER
    interrupt_set_enable: MMIO(Interrupt_Bitmap, .rw),

    _reserved_4: [124]u8 = undefined,

    /// a.k.a. ICER
    interrupt_clear_enable: MMIO(Interrupt_Bitmap, .rw),

    _reserved_84: [124]u8 = undefined,

    /// a.k.a. ISPR
    interrupt_set_pending: MMIO(Interrupt_Bitmap, .rw),

    _reserved_104: [124]u8 = undefined,

    /// a.k.a. ICPR
    interrupt_clear_pending: MMIO(Interrupt_Bitmap, .rw),
...
pub const Exception = chip.Exception;

pub const Vector_Table = chip.reg_types.Vector_Table;
...
pub const SCB = extern struct {
    ...
    /// a.k.a. VTOR
    vector_table: MMIO(*allowzero const Vector_Table, .rw),
